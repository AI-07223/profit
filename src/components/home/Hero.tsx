  ...
  return (
    <section className="relative min-h-[600px] flex items-center bg-zinc-900 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1596838132731-3301c3fd4317?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-20"></div>
      </div>
      ...
      <div className="container mx-auto px-4 z-10 relative py-20">
        <div className="max-w-3xl">
          ...
          <p className="text-gray-300 text-lg md:text-xl mb-10 leading-relaxed max-w-2xl animate-in fade-in slide-in-from-left duration-700 delay-200">
            ...
            We provide comprehensive white label solutions, turnkey software, and premium support.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-left duration-700 delay-300">
            <a href="#contact" className="px-8 py-4 bg-[#D4AF37] text-black font-bold text-lg rounded shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:bg-[#F4C430] hover:shadow-[0_0_30px_rgba(212,175,55,0.5)] transition-all text-center">
              Start Your Business
            </a>
            <a href="#demos" className="px-8 py-4 border border-[#D4AF37] text-[#D4AF37] font-bold text-lg rounded hover:bg-[#D4AF37] hover:text-black transition-all text-center">
              View Live Demos
            </a>
          </div>
        </div>
